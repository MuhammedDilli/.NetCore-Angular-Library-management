    ...
    public class LibraryController : ControllerBase
    {
        ...
        public ActionResult Register(User user)
        {
            ...
            var body = $"""
                            <html>
                                <body>
                                    <h4>Merhaba Sevgili , {user.FirstName} {user.LastName}</h4>
                                    <h3>
                                        Hesabınız oluşturuldu ve onay isteği yöneticinize gönderildi. İstek yönetici tarafından onaylandıktan sonra bir e-posta alacaksınız ve hesabınıza giriş yapabileceksiniz.
                                    </h3>
                                    <h3>Teşekkürler</h3>
                                </body>
                            </html>
            ...
            return Ok(@"Kaydolduğunuz için teşekkür ederiz.
                         Hesabınız onay için gönderildi.
                             Onaylandığında bir e-posta alacaksınız.");
        }
